            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                                            <?php foreach($listVenID as $result): ?>
                        <form id="edit-user" data-parsley-validate class="form-horizontal form-label-left" method="POST"
                            enctype="multipart/form-data" action="<?php echo base_url('admin/vendors/update_vendors'); ?>">
                             <input type="text" id="ven_id" name="ven_id" readonly="true" value="<?php echo $result->ven_id ?>">

                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                    <label class="control-label" for="name">ชื่อ
                                    </label>
                                    <input type="text" id="name" name="name" value="<?php echo $result->ven_name ?>" class="form-control ">
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                    <label class="control-label" for="lastname">นามสกุล
                                    </label>
                                    <input type="text" id="lastname" name="lastname" value="<?php echo $result->ven_lastname ?>" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                                    ...
                                    <input type="tel" id="tel" name="tel" class="form-control " value="<?php echo $result->tel ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
