                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo base_url('admin/profile');?>">
                                <i class="fas fa-user"></i>จัดการข้อมูลส่วนตัว</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/users/index');?>">
                                <i class="fas fa-users"></i>จัดการข้อมูลพนักงาน</a>
                        </li>
                        <li class="has-sub">
                            <!-- <a href="Product/index"> -->
                            <a href="<?php echo base_url('admin/products/index');?>">
                                <i class="fas fa-chart-bar"></i>จัดการสินค้า</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/List_Product');?>">
                                <i class="far fa-check-square"></i>จัดการสต็อกสินค้า</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/Stock');?>">
                                <i class="fas fa-calendar-alt"></i>จัดการวัตถุดิบ</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/List_Stock');?>">
                                <i class="fas fa-map-marker-alt"></i>จัดการสต็อกวัตถุดิบ</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/vendors/index');?>">
                                <i class="fas fa-map-marker-alt"></i>จัดการผู้จัดส่งสินค้าภายนอก</a>
                        </li>

                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/order/index');?>">
                                <i class="fas fa-map-marker-alt"></i>จัดการสั่งซื้อ</a>
                        </li>

                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/production/index');?>">
                                <i class="fas fa-map-marker-alt"></i>จัดการแพ็คสินค้า</a>
                        </li>

                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/transport/index');?>">
                                <i class="fas fa-map-marker-alt"></i>จัดการขนส่งสินค้า</a>
                        </li>

                        <li class="has-sub">
                            <!-- <a href="<?php echo base_url('admin/partner/index');?>"> -->
                              <a href="<?php echo base_url('admin/partner/index');?>">
                                <i class="fas fa-map-marker-alt"></i>จัดการหุ้นส่วน</a>
                        </li>                       

                        <li class="has-sub">
                            <a href="<?php echo base_url('login/logout');?>">
                                <i class="fas fa-map-marker-alt"></i>ออกจากระบบ</a>
                        </li>                                             
<!--                         <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Pages</a>
